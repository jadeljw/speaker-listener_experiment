...
load('E:\DataProcessing\speaker-listener_experiment\SpeakerData\Speaker01-CFY-read_retell_valid.mat',...
    'data_speakerA_read_boradband_valid');
load('E:\DataProcessing\speaker-listener_experiment\SpeakerData\Speaker02-FS-read_retell_valid.mat',...
    'data_speakerB_read_boradband_valid');



data_EEG_speakerA = data_speakerA_read_boradband_valid(speaker_story_read_order);
data_EEG_speakerB = data_speakerB_read_boradband_valid(speaker_story_read_order);
...
for r = 1 : cca_comp
    ...
    cd(strcat(p,'\listener',dataName(1:3),'\read'));
