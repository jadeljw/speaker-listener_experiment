...
% listener's EEG
%% dataName
dataName = '12-JSH-Listener-ICA-reref-filter_type.mat';

%% attend matrix
% load('E:\DataProcessing\speaker-listener_experiment\mfiles\CountBalanceTable\CountBalanceTable_listener12.mat');
...
if broadband
    % load Listener data
    load(strcat('E:\DataProcessing\speaker-listener_experiment\ListenerData\',dataName),'listener_boradband_read','listener_boradband_retell');
    data_EEG_listener = [listener_boradband_read listener_boradband_retell];
    ...
    data_EEG_speakerA = [data_speakerA_read_boradband_valid(1:14) data_speakerA_retell_boradband_valid(1:14)];
    data_EEG_speakerB = [data_speakerB_read_boradband_valid(1:14) data_speakerB_retell_boradband_valid(1:14)];
...
if theta
    % load Listener data
    load(strcat('E:\DataProcessing\speaker-listener_experiment\ListenerData\',dataName),'listener_theta_read','listener_theta_retell');
    ...
    data_EEG_listener = [listener_theta_read listener_theta_retell];
