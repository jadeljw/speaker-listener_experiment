...
%% band name
lambda = 2^5;
band_name = strcat(' 64Hz 2-8Hz sound from EEG lambda',num2str(lambda),' 10-65s attend only');
...
% EEGBlock = EEGBlock';
audio_EEGBlock = [data_retell(1:6) data_read(1:8)];
...
% combine
EEGBlock = [data_retell(1:6) data_read(1:8)];
EEGBlock = EEGBlock';
...
AttendTarget = [AttendTarget(1:6);AttendTarget(15:22)];
%% timelag
Fs = 64;
