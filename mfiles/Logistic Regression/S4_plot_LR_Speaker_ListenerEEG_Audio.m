...
for band_select = 1 : length(band_name)
    ...
    for type_select = 1 : length(type)
        ...
        for chn = 1 : length(speaker_chn)
            ...
            data_name = strcat('Audio Speaker-ListenerEEG Logstic Regresssion r^2 Result-',label66{speaker_chn(chn)},'-',band_name{band_select},'-',type{type_select},'.mat');
            data_path = strcat('E:\DataProcessing\speaker-listener_experiment\Logistic Regression\plot\Audio-SpeakerEEG-listener\',band_name{band_select},'\',type{type_select},'\',num2str(chn),'-',label66{speaker_chn(chn)},'\');
