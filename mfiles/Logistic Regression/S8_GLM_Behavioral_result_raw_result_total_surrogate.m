...
for surrogate_select = 1 : surrogate_num
    ...
    for band_select = 1 : length(band_name)
        ...
        load(strcat('E:\DataProcessing\speaker-listener_experiment\Surrogate\0-raw r value mat\Speaker-listenerEEG\surrogate',num2str(surrogate_select),'\',band_file_name,'\Correlation_mat.mat'));
