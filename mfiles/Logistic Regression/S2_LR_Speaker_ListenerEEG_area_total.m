...
R_squared_mat_speaker_total = zeros(listener_num,length(chn_area_labels),length(timelag));
...
%         R_squared_mat_total = zeros(listener_num,length(timelag));
...
%                     close;
            ...
            R_squared_mat_speaker_total(:,chn_area_select,:) = R_squared_mat;
...
%         close
        ...
        save(save_name,'R_squared_mat_speaker','R_squared_mat_speaker_total');
        %
        p = pwd;
