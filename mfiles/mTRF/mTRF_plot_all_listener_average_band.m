...
for band_select = 1 : length(band_name)
    ...
    %% load data
    data_path = strcat('E:\DataProcessing\speaker-listener_experiment\Plot\timelag plot\mTRF\',band_name{band_select},'\mTRF_sound_EEG_result across timelags all listener.mat');
    load(data_path);
...
%     end
    ...
    legend('Attended decoder','significant¡Ù50%','Unattended decoder','significant¡Ù50%','Location','northwest');ylim([30,80]);
