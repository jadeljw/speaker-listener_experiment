...
% broadband
% data_EEG_speakerA = [data_speakerA_read_boradband_valid(1:14)...
%     data_speakerA_retell_boradband_valid(1:7)...
%     data_speakerA_retell_boradband_valid(15)...
%     data_speakerA_retell_boradband_valid(9:14)];
...
for j = 1 : length(timelag)
    ...
    saveName1 = strcat('SpeakerA Reconstruction Acc using mTRF method timelag',num2str(timelag(j)),'ms',band_name,'.jpg');
    ...
    %% save data
    saveName = strcat('mTRF_sound_speakerA_EEG_result+',num2str(timelag(j)),'ms',band_name,'.mat');
...
saveName = strcat('SpeakerA Reconstruction Acc using mTRF method across timelag',band_name,'.jpg');
% saveName1 = strcat('Reconstruction Accuracy using mTRF method for attend decoder.jpg');
title(saveName1(1:end-4));
legend('AudioA ');
saveas(gcf,saveName);
