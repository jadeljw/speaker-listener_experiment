...
for i = 1 : 20
    ...
    for band_select = 1 : length(band_name)
        ...
        for plot_page = 1 : round(length(speaker_chn)/plot_page_each)
            ...
            save_name = strcat('mTRF SpeakerEEG-listenerEEG GFP-',band_name{band_select},'-page',num2str(plot_page),'-',file_name,'.jpg');
            legend('attend','unattend');
        ...
        save_name = strcat('mTRF SpeakerEEG-listenerEEG GFP-',band_name{band_select},'-',file_name,'.mat');
        save(save_name,'model_attend','model_unattend',...
