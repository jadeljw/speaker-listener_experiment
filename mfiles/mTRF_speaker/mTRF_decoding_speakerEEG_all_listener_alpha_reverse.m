...
mkdir('alpha reverse zscore power');
cd('alpha reverse zscore power');
...
for i = 1 : 20
    ...
    %% band name
    lambda = 2^5;
    band_name = strcat(' 64Hz alpha speakerEEG mTRF Listener',dataName(1:3),' lambda',num2str(lambda),' 10-55s');
...
%         timelag = 0;
    ...
    for chn = 1 : length(speaker_chn)
        ...
        for j = 1 : length(timelag)
            ...
            Decoding_result_attend_decoder = recon_AttendDecoder_attend_corr.^2-recon_AttendDecoder_unattend_corr.^2;
            ...
            Decoding_result_unattend_decoder = recon_UnattendDecoder_unattend_corr.^2-recon_UnattendDecoder_attend_corr.^2;
