...
for band_select = 1 : length(band_name)
    ...
    %% load plot data
    data_name = strcat('mTRF_sound_SpeakerA_EEG_backward_result_timelag-150ms_',band_name{band_select},'.mat');
    data_path = strcat('E:\DataProcessing\speaker-listener_experiment\Backward model\SpeakerA\',band_name{band_select});
    ...
    save_name = strcat('mTRF-sound-SpeakerA-EEG-backward-result-',band_name{band_select},'.jpg');
