...
%     
%     for i= 1 : 28
%         data_left_gamma{i} = ft_preproc_lowpassfilter(data_left{i},fs_down,lowpass_filter);
%         data_right_gamma{i} = ft_preproc_lowpassfilter(data_right{i},fs_down,lowpass_filter);
%     end
