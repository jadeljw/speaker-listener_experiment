...
%% remove artificial
cfg = [];
cfg.component = [1 3 16 25 36 56 60 64]; % to be removed component(s)
...
% data_speaker2_reref = ft_preprocessing(cfg,data_speaker2_total_resample);
...
cfg.bpfilter = 'yes';
cfg.bpfreq = [30 45];
data_filtered_gamma = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [1 45];
data_filtered_broadband_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [4 8];
data_filtered_theta_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [8 15];
data_filtered_alpha_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [15 30];
data_filtered_beta_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [1 4];
data_filtered_delta_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [30 45];
data_filtered_gamma_hilbert = ft_preprocessing(cfg,data_speaker2_reref);
