...
cfg.bpfilter = 'yes';
cfg.bpfreq = [1 45];
data_filtered_broadband = ft_preprocessing(cfg,data_comp_speaker1);

% theta
cfg = [];
cfg.bpfilter = 'yes';
cfg.bpfreq = [4 8];
data_filtered_theta = ft_preprocessing(cfg,data_comp_speaker1);

% alpha
cfg = [];
cfg.bpfilter = 'yes';
cfg.bpfreq = [8 15];
data_filtered_alpha = ft_preprocessing(cfg,data_comp_speaker1);

% beta
cfg = [];
cfg.bpfilter = 'yes';
cfg.bpfreq = [15 30];
data_filtered_beta = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.bpfilter = 'yes';
cfg.bpfreq = [1 4];
data_filtered_delta = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.bpfilter = 'yes';
cfg.bpfreq = [30 45];
data_filtered_gamma = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [1 45];
data_filtered_broadband_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [4 8];
data_filtered_theta_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [8 15];
data_filtered_alpha_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [15 30];
data_filtered_beta_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [1 4];
data_filtered_delta_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
...
cfg.hilbert = 'abs';
cfg.bpfreq = [30 45];
data_filtered_gamma_hilbert = ft_preprocessing(cfg,data_comp_speaker1);
