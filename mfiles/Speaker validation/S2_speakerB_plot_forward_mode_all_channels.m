...
for type_select = 1 : length(data_type)
    ...
    %% load data
    load(strcat('E:\DataProcessing\speaker-listener_experiment\Speaker Validation\1-forward model\all channels\AudioB_speakerB_forward_',data_type{type_select},'.mat'));
