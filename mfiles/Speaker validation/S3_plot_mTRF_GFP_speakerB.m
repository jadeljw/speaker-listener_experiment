...
% Figure 2
mkdir('SpeakerB Audio');
cd('SpeakerB Audio');

%% load data
load('E:\DataProcessing\speaker-listener_experiment\Speaker Validation\1-forward model\all channels\AudioB_speakerB_forward_afterICA.mat');
...
for band_select = 1 : length(band_name)
    ...
    % select data
    temp_data_model = eval(strcat('Audio_speakerB_forward.',band_name{band_select},'.model'));
