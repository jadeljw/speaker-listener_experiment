...
for type_select = 1 : length(data_type)
    ...
    %% load data
    load(strcat('E:\DataProcessing\speaker-listener_experiment\Speaker Validation\1-forward model\all channels\AudioA_speakerA_forward_',data_type{type_select},'.mat'));
        ...
        for i = 1 : page_number
            for j = 1 : plot_number
                ...
                if j > 8
                    ...
                    title(chn_area_labels{speaker_chn(select_chn)});
