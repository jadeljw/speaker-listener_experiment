    ...
    for chn_area_select = 1 : length(chn_area_labels)
        ...
        for listener_select = 1 : listener_num
            ...
            if data_max_value_precede(listener_select,1) ~=0
                ...
                w_precede_att(listener_select,:) = NaN;
                w_precede_trans_att(listener_select,:) = NaN;
                
                
                w_precede_unatt(listener_select,:) = NaN;
                w_precede_trans_unatt(listener_select,:) = NaN;
            ...
            if data_max_value_follow(listener_select,1) ~=0
                ...
                w_follow_att(listener_select,:) = NaN;
                w_follow_trans_att(listener_select,:) = NaN;
                
                w_follow_unatt(listener_select,:) = NaN;
                w_follow_trans_unatt(listener_select,:) = NaN;
                
                
            end
            
            %% combine before and after
            if data_max_value_precede(listener_select,1) ~=0 && data_max_value_follow(listener_select,1) ~=0
