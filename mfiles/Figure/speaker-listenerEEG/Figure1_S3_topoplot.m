        ...
        if ~isempty(x_ind)
            for ind_select = 1 : length(x_ind)
                ...
                for listener_select = 1 : listener_num
                    ...
                    data_path = strcat('E:\DataProcessing\speaker-listener_experiment\Figure\0-original r value\Speaker-listenerEEG\raw r value\',band_file_name,'\',listener_file_name,'\',chn_area_labels{x_ind(ind_select)});
                ...
                title(strcat(save_name(1:end-4),' r=',num2str(data_for_imagesc(x_ind(ind_select),y_ind(ind_select)))));
