...
for band_select = 1 : length(band_name)
    ...
    Rsquared_peak_latency(:,2) = data_max_index_follow(listener_select,1)+split_index;
    ...
    save_name = strcat('Highest R^2 value weights-',band_file_name);
    suptitle(save_name);
    saveas(gcf,strcat(save_name,'.jpg'));
    saveas(gcf,strcat(save_name,'.fig'));
    close
    ...
    save_name = strcat('Highest R^2 value trans weights-',band_file_name);
    suptitle(save_name);
    saveas(gcf,strcat(save_name,'.jpg'));
    saveas(gcf,strcat(save_name,'.fig'));
    ...
    save_name = strcat('Coeffciets-',band_file_name);
    suptitle(save_name);
    saveas(gcf,strcat(save_name,'.jpg'));
    saveas(gcf,strcat(save_name,'.fig'));
