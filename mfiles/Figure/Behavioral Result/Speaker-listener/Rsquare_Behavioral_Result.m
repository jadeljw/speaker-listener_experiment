...
for band_select = 1 : length(band_name)
    ...
    for chn_area_select = 1 : length(chn_area_labels)
        ...
        load(strcat('E:\DataProcessing\speaker-listener_experiment\Figure\Speaker-listenerEEG\5-logistic regression\peak\',band_file_name,'\',...
            chn_area_labels{chn_area_select},'\Rsquared_peak-',band_file_name,'.mat'));
        %% correlation
        ...
        %% save data
        save_name = strcat('Correlation between R^2 and behavioral result-',band_file_name,'-',chn_area_labels{chn_area_select},'.mat');
