...
for band_select = 1 : length(band_name)
    ...
    %% load R^2 data
    load(strcat('E:\DataProcessing\speaker-listener_experiment\Figure\Audio-listener\zscore\2-logistic regression\8.latency and zscore\',...
    ...
    for i = 1: length(Behavioral_result_label)
        ...
        [temp_R, temp_p] = corr(Behavioral_result_select, Rsquared_peak_zscore);
    ...
    %% save data
    save_name = strcat('Correlation between latency and behavioral result-',band_file_name,'.mat');
